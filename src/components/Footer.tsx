...
export default function Footer({ onOpenConsultation }: FooterProps) {
  return (
    <footer className="bg-black text-ivory border-t border-white/5 pt-20 pb-10 relative overflow-hidden font-primary">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="grid gap-10 sm:grid-cols-2 md:grid-cols-4 pb-16 border-b border-white/5 text-right">
          ...
          <div className="md:col-span-2 space-y-6">
            <div className="flex items-center gap-3 justify-start flex-row-reverse">
              ...
              <div className="text-right">
                <span className="font-primary text-lg font-bold uppercase tracking-[0.2em] text-white block">لايـتـك</span>
            ...
            <div className="flex items-center gap-4 justify-start flex-row-reverse">
              ...
              <a 
                ...
                target="_blank" 
                rel="noreferrer" 
                className="rounded-full border border-white/10 bg-white/5 hover:border-gold/30 hover:text-gold p-2 transition-colors duration-300 flex items-center gap-1.5 text-[10px] font-primary px-3 uppercase tracking-wider font-bold"
              >
          ...
          <div className="space-y-4">
            <h4 className="font-primary text-[10px] uppercase tracking-widest text-gold font-semibold">المنظومة التقنية</h4>
          ...
          <div className="space-y-4">
            <h4 className="font-primary text-[10px] uppercase tracking-widest text-gold font-semibold">الفئات المستهدفة</h4>
            <ul className="space-y-2.5 text-xs text-ivory/50">
        ...
        {/* Bottom Bar */}
        <div className="mt-10 flex flex-col md:flex-row justify-between items-center gap-6 font-primary text-[9px] uppercase tracking-wider text-ivory/30 border-t border-white/5 pt-8 text-center md:text-right w-full">
